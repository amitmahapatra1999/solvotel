...
export default function Billing() {
  ...
  const handleCheckIn = async (bill) => {
    try {
      setCheckInOutLoadingId(bill.billing._id);
                    ...
                    .filter((bill) => {
                      ...
                      if (filterStatus === "Booked") {
                        return (
                          ...
                          bill.booking.CheckedOut === false &&
                          bill.billing.Cancelled !== "yes"
                        );
                      }
                      if (filterStatus === "Checked In") {
                        return (
                          bill.booking.CheckedIn === true &&
                          bill.booking.CheckedOut === false &&
                          bill.billing.Cancelled !== "yes"
                        );
                      }
                      if (filterStatus === "Checked Out") {
                        return (
                          bill.booking.CheckedIn === true &&
                          bill.booking.CheckedOut === true &&
                          bill.billing.Cancelled !== "yes"
                        );
                      }
                      if (filterStatus === "Cancelled") {
                        return bill.billing.Cancelled === "yes";
                      }
                    ...
                    .map((bill, index) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <CustomBodyCell>
                            Adults: {bill?.booking?.adults || "N/A"} <br />{" "}
                            Child:
                            ...
                            {bill?.booking?.CheckedIn &&
                              !bill?.booking?.CheckedOut && (
                                <Button
                                  ...
                                  disabled={
                                    checkInOutLoadingId === bill.billing._id
                                  }
